...
/**
 * Abstract class for Graphics. Contains all the scaling methods, that are common and needed for both
 * engines. Also contains all common atributes for both engines.
 */
